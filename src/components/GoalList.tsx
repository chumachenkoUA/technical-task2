            ...
            <ul className={"goal-list container"}>
                {goalList.map((goal,index) => (
                    <li key={goal.title+goal.description+index} className={"goal-list__item"}>
                        ...
                        <button className={"delete-button goal-list__delete-button"} onClick={() => handleDeleteGoal(goal)}>
                        <svg className={"delete-button__icon"}  viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
